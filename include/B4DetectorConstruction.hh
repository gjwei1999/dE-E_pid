...
//    virtual void ConstructSDandField();
  ...
  private:
    ...
    G4VPhysicalVolume*   fSiliconPV; // the absorber physical volume
    G4VPhysicalVolume*   fScintillatorPV;      // the gap physical volume
...
inline const G4VPhysicalVolume* B4DetectorConstruction::GetSiliconPV() const { 
  return fSiliconPV; 
}

inline const G4VPhysicalVolume* B4DetectorConstruction::GetScintillatorPV() const  { 
